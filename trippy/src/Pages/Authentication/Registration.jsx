                ...
                <div className="card-body w-full lg:w-7/12 bg-base-100/30 backdrop-blur-xl p-8 lg:p-12">
                    ...
                    <form onSubmit={handleRegister} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="form-control">
                                <label className="label"><span className="label-text font-bold text-base-content/70">Photo URL</span></label>
                                <input className="input input-bordered input-glass w-full" type="text" name="photoURL" placeholder="https://..." />
                            </div>
                        </div>
